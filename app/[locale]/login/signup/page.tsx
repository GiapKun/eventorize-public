            ...
            <main>
                ...
                <div className="min-h-screen bg-gray-100 flex items-center justify-center">
                    ...
                    <div className=" z-10 py-14 px-14 flex flex-col items-center w-full max-w-lg p-6 bg-white dark:bg-medium shadow-lg rounded-xl m-6">
                        <Link href="/">
                            <p className="text-4xl font-bold text-primary font-jua mb-6">eventorize</p>
                        </Link>
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-200 mb-6">{t("auth:Welcome")}</h2>
                        <SignUpForm />
                    </div>
                </div>
            </main>
